...
} elseif ($_instance->childHasBeenRendered('l3924711519-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3924711519-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3924711519-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3924711519-0');
} else {
    $response = \Livewire\Livewire::mount('inc.contact-form', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3924711519-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php /**PATH C:\xampp\htdocs\merlintechbd\merlin_app\resources\views/livewire/inc/footer.blade.php ENDPATH**/ ?>