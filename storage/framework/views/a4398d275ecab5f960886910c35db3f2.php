...
} elseif ($_instance->childHasBeenRendered('vNugoKp')) {
    $componentId = $_instance->getRenderedChildComponentId('vNugoKp');
    $componentTag = $_instance->getRenderedChildComponentTagName('vNugoKp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vNugoKp');
} else {
    $response = \Livewire\Livewire::mount('inc.top-menu', []);
    $html = $response->html();
    $_instance->logRenderedChild('vNugoKp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
} elseif ($_instance->childHasBeenRendered('Y9ghThw')) {
    $componentId = $_instance->getRenderedChildComponentId('Y9ghThw');
    $componentTag = $_instance->getRenderedChildComponentTagName('Y9ghThw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Y9ghThw');
} else {
    $response = \Livewire\Livewire::mount('inc.footer', []);
    $html = $response->html();
    $_instance->logRenderedChild('Y9ghThw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\xampp\htdocs\merlintechbd\merlin_app\resources\views/layouts/app.blade.php ENDPATH**/ ?>