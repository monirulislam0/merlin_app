    ...
    <section class="hot-products-three">
        <div class="container">
            <div class="section-title text-center">
                ...
                <h2 class="section-title__title">Today’s new hottest products
                    <br> available now</h2>
            </div>
            <div class="row">
                        ...
                        <div class="hot-products__single-inner">
                            ...
                            <div class="hot-products__img-box">
                                <div class="hot-products__img">
                                    <img src="{{ asset('sy/'.$item['small_image']) }}" alt="{{ $item['name'].'-'.$item['unit'] }}">
                                </div>
                            </div>
                            <div class="hot-products__content">
                                ...
                                <div class="hot-products__btn-box">
                                    <a  wire:click="itemAddToCart('{{ $item['id'] }}')"  class="hot-products__btn thm-btn">Add to cart</a>
                                </div>
                            </div>
                        </div>
                    </div>
