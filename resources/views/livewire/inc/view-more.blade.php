                    ...
                    <div class="carousel-item {{ ($sl==1) ? 'active':'' }}">
                        <div class="col-md-3 col-12">
                            <div class="card caro-card p-3">
                                <div class="card-img">
                                    <img src="{{ asset('storage/'.$slider->image) }}" class="img-fluid mltpl-card-img ">
                                </div>
                                <h2 class="fs-5 fw-bold text-dark text-truncate-2 h-40 mt-3 mt-md-4 mb-2 mb-md-3 text-overflow-ctrl">
                                    <a target="_blank" href="{{ $slider->redirect_url }}" class="text-reset text-decoration-none hover-text-primary" tabindex="0">{{ $slider->title }}</a>
                                </h2>
                                <a target="_blank" href="{{ $slider->redirect_url }}" class="button-card">Visit</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
